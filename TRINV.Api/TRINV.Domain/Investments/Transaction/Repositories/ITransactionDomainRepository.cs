...
public interface ITransactionDomainRepository : IDomainRepository<Models.Transaction>
{
    ...
    Task<IEnumerable<TResult?>> FindAllByAssetId<TResult>(string assetId, Func<IQueryable<Models.Transaction>, IQueryable<TResult>> predicate, CancellationToken cancellationToken);
